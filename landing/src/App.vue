...
const API_BASE = 'https://api-hotpot.assetux.com';
    ...
    <header class="header glass">
      <div class="container header-inner">
        ...
        <nav class="nav">
          ...
          <a href="https://hotpot.assetux.com/Hotpot.apk" target="_blank" class="nav-cta">
      ...
      <div class="container hero-inner">
        <div class="hero-content animate-in">
          ...
          <div class="hero-actions">
            <a href="https://hotpot.assetux.com/Hotpot.apk" class="btn-download android">
    ...
    <section id="radius" class="section radius-section">
      ...
      <div class="container content-center">
        ...
        <div class="stat-cards">
          ...
          <div class="stat-card glass">
            <div class="stat-emoji">🪙</div>
            <div class="stat-val">${{ stats.asxPriceUsd?.toFixed(6) || '–' }}</div>
